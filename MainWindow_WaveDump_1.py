...
class Ui_MainWindow(object):
    ...
    def setupRunUI(self):
        ...
        # self.pushButton_generateConfigFile.clicked.connect(self.deviceConfigTabWidget_ins.writeConfigFile)
        ...
        self.lineEdit_Crystal = QtWidgets.QLineEdit(self.gridLayoutWidget_RunChanges)
        # self.gridLayout_RunChanges.addWidget(self.lineEdit_Crystal, row, column, 1, 5)
        self.lineEdit_Crystal.setText("crystal_type")
        # self.lineEdit_chip_no.editingFinished.connect(self.make_new_folder)
        columnWids.append(self.lineEdit_Crystal)
        ...
        # self.checkBox_s.setCheckState(bool(self.deviceConfigTabWidget_ins.valueDict["STARTSTOP"]))
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("Wave Dump Dessy")
        MainWindow.setCentralWidget(self.centralwidget)

        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(10,0,1180,500))
        ...
        self.deviceConfigTabWidget_ins = tab_digitizer_config(self.deviceConfigTabWidget)
    ...
    def start_WaveDump(self):
        ...
        self.emptyFile()
        # files = self.tab_PIcontrol_inst.writeConfigFile()
        self.chEnCheckBox()
        self.WDstarted = True
        print('debug')
